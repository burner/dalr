...
dalr.filereader.o dalr.itemsettrie.o
...
dalr.itemsettrie.o: dalr/itemsettrie.d dalr/itemset.d dalr/item.d Makefile
	dmd $(CFLAGS) -c dalr/itemsettrie.d -ofdalr.itemsettrie.o
